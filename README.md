...
Here is a plot of the result produce from the model. Intial condition x0 = 10 and dx/dt = 0. Ran for 10 seconds with the coefficient of restitution e equal 0.8.
